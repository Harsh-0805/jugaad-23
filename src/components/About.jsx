...
function About() {
  return (
    <>
    <section id="About" className="aboutjugaad min-h-screen bg-gradient-to-b from-yellow-400 via-yellow-500 to-yellow-700 flex flex-col justify-center items-center">
  <div id="anima">
